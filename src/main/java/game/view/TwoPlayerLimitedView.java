...
/**
 * Prints 2 player continues game
 * @author David Jackson
 */
public class TwoPlayerLimitedView{

	public TwoPlayerLimitedView(int seed, int limit) {

		System.out.println("Version 1 is Picked.");
		System.out.println("Seed:" + seed);
		System.out.println("Turn Limit:" + limit);
	}
	...
	public void printGameOver(int winner, int playerOneScore, int playerTwoScore, boolean tie) {
